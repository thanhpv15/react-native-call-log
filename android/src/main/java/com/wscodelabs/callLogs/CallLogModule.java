...
public class CallLogModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void getLog(String phoneType, String phone, Callback callBack) {
        boolean hasSlotId = false;
        Uri uri;
        StringBuffer stringBuffer = new StringBuffer();
        String deviceMan = android.os.Build.MANUFACTURER;
        ...
        while (cursor.moveToNext()) {
            ...
            if (dir == null || phoneType == null)  continue;
            if (!dir.equals(phoneType) && !phoneType.equals("IGNORE")) continue;
